...
void display(void) {
	...
	glStencilOp(GL_KEEP, GL_KEEP, GL_REPLACE); 	//Replace where rendered
	...
	glStencilFunc(GL_NOTEQUAL, 1, 1); //Where a 1 was not rendered.. try GL_NOTEQUAL
